...
test('it throws if no id provided', () => {
  ...
  expect(() => (require('../sign-up-user'))).toThrow('you must provide one parameter for id (ex: yarn node sign-up-user.js your-id)')
})

test('it sends request', () => {
  process.argv = ['node', 'sign-up-user.js', 'your-id']
  ...
  expect(axios.put).toHaveBeenCalledWith('https://d1834iic8b.execute-api.eu-west-3.amazonaws.com/sign-up', {
    id: 'your-id',
