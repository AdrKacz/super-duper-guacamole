...
// ===== ===== ===== ===== =====
// ===== ===== ===== ===== =====
// RSE KEY PAIRS Convert

List<String> rsaKeyPairToString(
...
AsymmetricKeyPair<RSAPublicKey, RSAPrivateKey> stringToRsaKeyPair(
    List<String> rsaKeyPairString) {
  if (rsaKeyPairString.length != 5) {
    throw 'rsa key pair must have exactly five parameters: $rsaKeyPairString';
  }

  String n = rsaKeyPairString[0];
  String e = rsaKeyPairString[1];
  String d = rsaKeyPairString[2];
  String p = rsaKeyPairString[3];
  String q = rsaKeyPairString[4];
