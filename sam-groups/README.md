...
- `register` - Code for the application's Register Lambda function.
- `switchgroupd` - Code for the application's Switch Group Lambda function.
- `sendmessage` - Code for the application's Send Message Lambda function.
...
```bash
sam logs -n RegisterFunction --stack-name sam-group --tail
sam logs -n SwitchGroupFunction --stack-name sam-group --tail
sam logs -n SendMessageFunction --stack-name sam-group --tail
```
...
```bash
aws cloudformation delete-stack --stack-name sam-group
```
